...
public class BPaymentResult extends PaymentResult {
    ...
    private BPaymentResult(int totalPrice, String info1, String info2, Payment payment) {
        super(totalPrice, payment);
        this.bMockInformation1 = info1;
        this.bMockInformation2 = info2;
    }

    public static BPaymentResult create(int totalPrice, String info1, String info2, Payment payment) {
        return new BPaymentResult(totalPrice, info1, info2, payment);
    }
}
